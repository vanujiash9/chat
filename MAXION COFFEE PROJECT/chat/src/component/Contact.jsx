      ...
      <div>
        <section className="bg-[#FFFAFF] dark:bg-[#4C2113]">
          <div className="container px-6 py-12 mx-auto">
            <div>
              <p className="font-medium text-[#DCB485] dark:text-[#DCB485]">Contact us</p>
              <h1 className="mt-2 text-2xl font-semibold text-[#4C2113] dark:text-[#FFFFFF] md:text-3xl">Get in touch</h1>
              <p className="mt-3 text-[#B38B60] dark:text-[#DCB485]">Our friendly team would love to hear from you.</p>
            </div>
            <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
              <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                  ...
                  <p className="mt-2 text-sm text-[#B38B60] dark:text-[#DCB485]">Our friendly team is here to help.</p>
                ...
                <div>
                  ...
                  <h2 className="mt-4 text-base font-medium text-[#4C2113] dark:text-[#FFFFFF]">Office</h2>
                  <p className="mt-2 text-sm text-[#B38B60] dark:text-[#DCB485]">Come say hello at our office HQ.</p>
                ...
                <div>
                  ...
                  <h2 className="mt-4 text-base font-medium text-[#4C2113] dark:text-[#FFFFFF]">Phone</h2>
                  <p className="mt-2 text-sm text-[#B38B60] dark:text-[#DCB485]">Mon-Fri from 8am to 5pm.</p>
