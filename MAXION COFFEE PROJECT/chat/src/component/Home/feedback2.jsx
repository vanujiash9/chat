      ...
      <div>
        <div className="py-12 px-4">
          <div className=" mx-auto container lg:max-w-[356px] md:max-w-[720px] max-w-[343px] py-8 px-8 bg-white shadow rounded-md">
            ...
            <button className="text-sm font-medium leading-none text-white px-6 py-4 bg-indigo-700 rounded w-full hover:bg-indigo-600 transform duration-300 ease-in-out">
              Submit Review
            </button>
          </div>
